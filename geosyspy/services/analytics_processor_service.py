...
class AnalyticsProcessorService:
    ...
    @retrying.retry(
        ...
        retry_on_exception=lambda exc: isinstance(exc, KeyError),
    )
    def wait_and_check_task_status(self, task_id: str):
        ...
        while True:
            ...
            if task_status == "Ended":
                ...
                raise Exception(
                    f"Task Status: {task_status}, Content: {response.content}"
                )

        return task_status

    def get_s3_path_from_task_and_processor(self, task_id: str, processor_name: str):
        ...
        if response.ok:
            dict_resp = json.loads(response.content)
            customer_code: str = dict_resp["customerCode"].lower().replace(
                "_", "-")
    ...
    def launch_mr_time_series_processor(
        self,
        polygon,
        start_date: str,
        end_date,
        ...
        processor_endpoint: str = urljoin(
            self.base_url,
    ...
    def launch_planted_area_processor(
        self, start_date: str, end_date: str, seasonfield_id: str
    ):
        ...
        payload = {
            "parametersProfileCode": ProcessorConfiguration.PLANTED_AREA.value[
                "profile"
            ],
            "data": [
                {
        ...
        processor_endpoint: str = urljoin(
            self.base_url,
            GeosysApiEndpoints.LAUNCH_PROCESSOR_ENDPOINT.value.format(
                ProcessorConfiguration.PLANTED_AREA.value["api_processor_path"]
            ),
        )
    ...
    def launch_harvest_processor(
        ...
        payload = {
            "parametersProfile": ProcessorConfiguration[harvest_type.name].value[
                "profile"
            ],
            "parameters": {
        ...
        processor_endpoint: str = urljoin(
            self.base_url,
            GeosysApiEndpoints.LAUNCH_PROCESSOR_ENDPOINT.value.format(
                ProcessorConfiguration[harvest_type.name].value["api_processor_path"]
            ),
        )
    ...
    def launch_emergence_processor(
        self,
        season_duration: int,
        season_start_day: int,
        season_start_month: int,
        ...
        # build payload for api call
        payload = {
            "parametersProfile": ProcessorConfiguration[emergence_type.name].value[
                "profile"
            ],
            "parameters": {
                "season_duration": season_duration,
        ...
        processor_endpoint: str = urljoin(
            self.base_url,
            GeosysApiEndpoints.LAUNCH_PROCESSOR_ENDPOINT.value.format(
                ProcessorConfiguration[emergence_type.name].value["api_processor_path"]
            ),
        )
    ...
    def launch_potential_score_processor(
        self,
        season_duration: int,
        season_start_day: int,
        season_start_month: int,
        ...
        # build payload for api call
        payload = {
            "parametersProfile": ProcessorConfiguration.POTENTIAL_SCORE.value[
                "profile"
            ],
            "parameters": {
                "end_date": end_date,
        ...
        processor_endpoint: str = urljoin(
            self.base_url,
            GeosysApiEndpoints.LAUNCH_PROCESSOR_ENDPOINT.value.format(
                ProcessorConfiguration.POTENTIAL_SCORE.value["api_processor_path"]
            ),
        )
    ...
    def launch_brazil_in_season_crop_id_processor(
        self,
        start_date: str,
        end_date: str,
        season: str,
        ...
        # build payload for api call
        payload = {
            "parametersProfile": ProcessorConfiguration.BRAZIL_IN_SEASON_CROP_ID.value[
                "profile"
            ],
            "parameters": {
                "start_date": start_date,
            ...
            "data": [{"id": "SeasonField:" + seasonfield_id + "@ID", "geom": geometry}],
        }

        processor_endpoint: str = urljoin(
            self.base_url,
            GeosysApiEndpoints.LAUNCH_PROCESSOR_ENDPOINT.value.format(
                ProcessorConfiguration.BRAZIL_IN_SEASON_CROP_ID.value[
                    "api_processor_path"
                ]
            ),
        )
    ...
    def launch_greenness_processor(
        ...
        processor_endpoint: str = urljoin(
            self.base_url,
            GeosysApiEndpoints.LAUNCH_PROCESSOR_ENDPOINT.value.format(
                ProcessorConfiguration.GREENNESS.value["api_processor_path"]
            ),
        )
    ...
    def launch_harvest_readiness_processor(
        self,
        start_date: str,
        end_date: str,
        sowing_date: str,
        ...
        # build payload for api call
        payload = {
            "parametersProfile": ProcessorConfiguration.HARVEST_READINESS.value[
                "profile"
            ],
            "parameters": {
                "start_date": start_date,
        ...
        processor_endpoint: str = urljoin(
            self.base_url,
            GeosysApiEndpoints.LAUNCH_PROCESSOR_ENDPOINT.value.format(
                ProcessorConfiguration.HARVEST_READINESS.value["api_processor_path"]
            ),
        )
