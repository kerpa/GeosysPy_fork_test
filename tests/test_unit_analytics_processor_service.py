...
class TestAnalyticsProcessorService:
    ...
    def test_get_mr_time_series_processor(self, post_response):
        ...
        task_id = self.service.launch_mr_time_series_processor(
    ...
    def test_get_s3_path_from_task_and_processor(self, get_response):
        ...
        s3_path = self.service.get_s3_path_from_task_and_processor(
            task_id="4d0980e07b7245d49419ff5ec87fff09", processor_name="mrts"
        )
