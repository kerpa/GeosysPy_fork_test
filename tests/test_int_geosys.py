...
class TestGeosys:
    ...
    def test_get_time_series_modis_ndvi(self):
        ...
        df = self.client.get_time_series(
            POLYGON, start_date, end_date, SatelliteImageryCollection.MODIS, [
                "NDVI"]
        )
    ...
    def test_get_satellite_image_time_series_modis_ndvi(self):
        ...
        df = self.client.get_satellite_image_time_series(
            POLYGON, start_date, end_date, [
                SatelliteImageryCollection.MODIS], ["NDVI"]
        )
        assert df.index.name == "date"
        ...
        assert {"mh11v4i225j4612", "mh11v4i226j4612"}.issubset(
            set(df["pixel.id"]))
    ...
    def test_get_mr_time_series(self):
        ...
        assert result.startswith(
            "s3://geosys-geosys-us/2tKecZgMyEP6EkddLxa1gV")
