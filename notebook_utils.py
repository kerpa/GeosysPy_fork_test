...
def read_mrts_data(str_path):
    ...
    path_data = os.path.join(
        str_path.split(
            "/")[-3], str_path.split("/")[-2], str_path.split("/")[-1]
    )
    ...
    data_files = {
        ...
        "raw_df": glob.glob(
            os.path.join(path_data, "MRTS-" + str_index +
                         str_func + "-Raw-2*.csv")
        )[0]
        if raw_data
        else None,
        "df": glob.glob(
            os.path.join(path_data, "MRTS-" + str_index + str_func + "-2*.csv")
        )[0]
        if str_smoother == "false"
        else None,
        "timeserie": glob.glob(
            os.path.join(path_data, "MRTS-" + str_index + str_func + "-2*.csv")
        )[0]
    ...
    dict_data = {
        ...
        "df": pd.read_csv(data_files["df"], sep=",")
        if str_smoother == "false"
        else None,
        "ts": pd.read_csv(data_files["timeserie"], sep=",")
        if str_smoother != "false"
        else None,
    }
...
def plot_mrts_dict(dict_data):
    ...
    if index != "reflectances":
        if dict_data["raw_df"] is not None:
            ...
            plt.plot(
                raw_df[index].loc[raw_df["denoised"] == True],
                "x",
                color="r",
                markersize=12,
                label="Denoised",
        ...
        if dict_data["ts"] is not None:
            ...
            df_smooth["date"] = pd.to_datetime(
                df_smooth["date"], format="%Y-%m-%d")
        ...
        if dict_data["raw_df"] is not None:
            ...
            plt.plot(
                raw_df["nir"].loc[raw_df["denoised"] == True],
                "x",
                color="r",
                markersize=12,
                label="Denoised",
            ...
            plt.plot(
                raw_df["red"].loc[raw_df["denoised"] == True],
                "x",
                color="r",
                markersize=12,
            )
            ...
            plt.plot(
                raw_df["green"].loc[raw_df["denoised"] == True],
                "x",
                color="r",
                markersize=12,
            )
            ...
            plt.plot(
                raw_df["blue"].loc[raw_df["denoised"] == True],
                "x",
                color="r",
                markersize=12,
            )
        ...
        if dict_data["ts"] is not None:
            ...
            plt.plot(df_smooth["green"], linewidth=2,
                     label="Smooth " + "green")
